"""São querys utilizadas na aula, só pra gente ter uma noçãoi geral de como funciona"""
...
#a classe que se deseja acessar é colocada em minúsculo e _set: Classe Order vira order_set.ALGUNFILTRO()
